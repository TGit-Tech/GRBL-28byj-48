...
The motors (28byj-48) are connected to a controller card (Arduino UNO) that uses the chip ULN2003. This board is connected to pins A0, A1, A2, A3 for the Y-Axis(IN1->IN4),  2, 3,4,5 Digital pins to the X-Axis(IN4->IN1), and 8,9,10,11 to the Z-Axis(IN4->IN1).
