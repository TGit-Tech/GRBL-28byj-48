...
{        
  ...
  if (current_block != NULL) {
    ...
    if (st.counter_y > 0) {
      ...
      if (costyy==1)   PORTC=0B001000;
      if (costyy==2)   PORTC=0B001100;
      if (costyy==3)   PORTC=0B000100;
      if (costyy==4)   PORTC=0B000110;
      if (costyy==5)  PORTC=0B000010;
      if (costyy==6)  PORTC=0B000011;
      if (costyy==7)  PORTC=0B000001;
      if (costyy==8) PORTC=0B0011001;
     }
    ...
    if (st.counter_z > 0) {
      ...
      if (costyz==1)   PORTB=0B001000;
      if (costyz==2)   PORTB=0B001100;
      if (costyz==3)   PORTB=0B000100;
      if (costyz==4)   PORTB=0B000110;
      if (costyz==5)  PORTB=0B000010;
      if (costyz==6)  PORTB=0B000011;
      if (costyz==7)  PORTB=0B000001;
      if (costyz==8) PORTB=0B001001;
     }
